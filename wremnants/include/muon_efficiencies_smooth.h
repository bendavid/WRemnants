...
namespace wrem {
    ...
    public:
        ...
        muon_efficiency_smooth_helper_base(HIST_SF &&sf_all, HIST_SF3D &&sf3D_all) :
    ...
    class muon_efficiency_smooth_helper:
        public muon_efficiency_smooth_helper_base<NSysts, HIST_SF, HIST_SF3D> {

    public:

        using base_t = muon_efficiency_smooth_helper_base<NSysts, HIST_SF, HIST_SF3D>;
        // inherit constructor
        using base_t::base_t;
    ...
    template<int NSysts, typename HIST_SF, typename HIST_SF3D>
    class muon_efficiency_smooth_helper<true, NSysts, HIST_SF, HIST_SF3D> :
        public muon_efficiency_smooth_helper_base<NSysts, HIST_SF, HIST_SF3D> {
    ...
    // specialization for two-lepton case
    template<int NSysts, typename HIST_SF, typename HIST_SF3D>
    class muon_efficiency_smooth_helper_syst<true, NSysts, HIST_SF, HIST_SF3D> :
        public muon_efficiency_smooth_helper_base<NSysts, HIST_SF, HIST_SF3D> {
