...
// base template for one lepton case
template <bool do_other, int NEtaBins, int NPtBins, int NCharges,
          typename HIST_SF>
...
public:
  using stat_base_t =
      muon_efficiency_binned_helper_stat_base<NEtaBins, NPtBins, NCharges,
                                              HIST_SF>;
...
// specialization for two-lepton case
template <int NEtaBins, int NPtBins, int NCharges, typename HIST_SF>
class muon_efficiency_binned_helper_stat<true, NEtaBins, NPtBins, NCharges,
                                         HIST_SF>
    : public muon_efficiency_binned_helper_stat_base<NEtaBins, NPtBins,
                                                     NCharges, HIST_SF> {
...
// specialization for two-lepton case
template <int NEtaBins, int NPtBins, int NCharges, typename HIST_SF>
class muon_efficiency_binned_helper_stat_iso<true, NEtaBins, NPtBins, NCharges,
                                             HIST_SF>
    : public muon_efficiency_binned_helper_stat_base<NEtaBins, NPtBins,
                                                     NCharges, HIST_SF> {
