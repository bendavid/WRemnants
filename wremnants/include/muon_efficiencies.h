...
muon_efficiency_helper_base(HIST_IDIPTRIGISO &&sf_idip_trig_iso, HIST_TRACKING &&sf_tracking, HIST_RECO &&sf_reco) :
  ...
  double scale_factor_product(float pt, float eta, float sapt, float saeta, int charge, bool pass_iso, bool with_trigger, int idx_nom_alt) const {
    ...
    ////
    // SYST UNCERTAINTY, FOR ALL STEPS
    ////
  ...
  stat_tensor_singleStep_t sf_singleStep_stat_var(float pt, float eta, int charge, int step) const {
    ...
    auto const sf_singleStep_ = (step == 0) ? sf_reco_ : sf_tracking_; // might be more general to read other stuff too
...
class muon_efficiency_helper : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {

public:

    using base_t = muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO>;
...
template<int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper<true, NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// base template for one lepton case
template<bool do_other, int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_stat : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// specialization for two-lepton case
template<int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_stat<true, NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// base template for one lepton case
template<bool do_other, int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_singleStep_stat : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// specialization for two-lepton case
template<int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_singleStep_stat<true, NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// base template for one lepton case
template<bool do_other, int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_syst : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
...
// specialization for two-lepton case
template<int NEtaBins, int NPtBins, typename HIST_IDIPTRIGISO, typename HIST_TRACKING, typename HIST_RECO>
class muon_efficiency_helper_syst<true, NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> : public muon_efficiency_helper_base<NEtaBins, NPtBins, HIST_IDIPTRIGISO, HIST_TRACKING, HIST_RECO> {
