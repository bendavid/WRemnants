...
def make_reco_over_gen_hists(df, results):
    ...
    axis_pt_reco_over_gen = hist.axis.Regular(1000, 0.9, 1.1, underflow=True, overflow=True, name = "reco_pt_over_gen", metadata={"type":"gen"})
    axis_qop_reco_over_gen = hist.axis.Regular(1000, 0.9, 1.1, underflow=True, overflow=True, name = "reco_qop_over_gen", metadata={"type":"gen"})
...
def make_hists_for_event_weights_perse(
    ...
    axis_weights = hist.axis.Regular(1000, 0.99, 1.01, underflow=True, overflow=True, name = "weights", metadata={"type":"gen"})
