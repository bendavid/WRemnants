...
ROOT.gInterpreter.Declare('#include "muon_efficiencies_binned_vqt_real_error.h"')

data_dir = f"{pathlib.Path(__file__).parent}/data/"

def make_muon_efficiency_helpers_binned_vqt_real_error(filename = data_dir + "/testMuonSF/allSmooth_GtoH.root",
    ...
    isolation3dfilename = "/gpfs/ddn/cms/user/bruschin/newfit2/Steve_Marc_Raj/files/isolation3DSFVQTrebinned.root"
    ...
    triggerminus3dfilename = "/gpfs/ddn/cms/user/bruschin/newfit2/Steve_Marc_Raj/files/triggerminus3DSFVQTrebinned.root"
    triggerminus3dhistoname = "SF3D_nominal_trigger_minus"
    #triggerplus3dfilename = f"{data_dir}/testMuonSF/triggerplus3DSFZQT.root"
    triggerplus3dfilename = "/gpfs/ddn/cms/user/bruschin/newfit2/Steve_Marc_Raj/files/triggerplus3DSFVQTrebinned.root"
    ...
    helper = ROOT.wrem_vqt_real_error.muon_efficiency_binned_helper[str(is_w_like).lower(),
