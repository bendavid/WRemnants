...
mainPath = "/eos/user/m/mciprian/www/WMassAnalysis/TnP/egm_tnp_analysis/results_test_globalMuons_byCharge_noMinos_RooMinimizerMinuit2"
workingPoints = ["iso"]
...
for wp in workingPoints:
    for era in eras:
        outdir = f"{mainPath}/compareEffAndSFbyCharge/{era}/{wp}/"
        file1  = f"{mainPath}/efficiencies_{era}/mu_{wp}_{elements[0]}/allEfficiencies_2D.root"
        file2  = f"{mainPath}/efficiencies_{era}/mu_{wp}_{elements[1]}/allEfficiencies_2D.root"
