...
parser.add_argument("-t","--test-data", default=[], nargs="*" , help="fitresult root file with test data (data, pseudodata)")
parser.add_argument("-l","--test-labels", default=[], nargs="*" , help="labels for test data (data, pseudodata) for plotting")
