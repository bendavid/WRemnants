...
def zmumu_perp_DeepMETReso():
    ...
    if False:
        ...
        rls.parameterizeGauss(jsIn, jsOut, comp, "p0", fitF, params, outDir_param, binning_qT, procLabel, metLabel, cParams=cParams, fitMin=0, fitMax=200, yMax=50, xMax=200, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = "power", [4.66409e-01, 3.46158e-01, 3.44635e+00], [False, False, False]
        rls.parameterizeGauss(jsIn, jsOut, comp, "p1", fitF, params, outDir_param, binning_qT, procLabel, metLabel, cParams=cParams, fitMin=2, fitMax=200, yMax=50, xMax=200, yTitle = "#sigma_{2} (GeV)")
        ...
        rls.addParam(jsOut, "p7", "[0]", [0.24])
        rls.addParam(jsOut, "p8", "[0]", [0.32])
...
if __name__ == "__main__":
    ...
    groups = datagroups2016("mz_wlike_with_mu_eta_pt_%s_nnpdf31.pkl.lz4" % met, wlike=True)
    ...
    binning_qT = list(functions.drange(0, 200, 0.5)) + [200]
