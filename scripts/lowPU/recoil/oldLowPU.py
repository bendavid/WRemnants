...
def do_dymumu_perp_RawPFMET_zlib():
    ...
    axis = "recoil_para_qT"
    hName = "recoil_corr_xy_perp_qTbinned_new"
    
    label_ = "%s_%s" % (hName, proc)
    groups.setHists(hName, "", label=label_, procsToRead=[proc], selectSignal=False)
    bhist = groups.groups[proc][label_]
    ...
    fitCfg['norm'], fitCfg['norm_cfg'] = [0.08, 0.20, 0.25], [1, 1, 1]
    

    recoil_qTbins = list(functions.drange(0, 50, 0.5)) +  list(range(50, 100, 1)) + list(range(100, 150, 2)) + [150]
    recoil_qTbins = list(functions.drange(0, 100, 0.5))
    
    nGauss = len(fitCfg['mean'])
    
    if False: 
        recoilLibs_zlib.doFitMultiGauss(bhist, comp, fitCfg, label, outDir_fits_v0, recoil_qTbins, qTmax=100, qTstartBin=1, xMin=-100, xMax=100, yRatio=1.15)
        return
    ...
    if False:
        ...
        fitF, params, cParams = rf.power_(), [7.39350e-02, 9.99747e-01, 1.27332e+01], [False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=30, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = rf.pw_poly4_power_(), [4.29656e+00, -4.45944e-01, 1.97011e-01, -2.37955e-02, 2.23406e-04, 3.93709e-01, 4.74875e+00], [False, False, False, False, False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=50, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = rf.pw_poly4_power_(), [6.86024e+00, -6.51794e-01, 2.08695e-01, -1.86247e-02, 1.60120e-04, 3.42283e-01, 5], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=30, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")

        fitF, params, cParams = rf.pw_poly4_power_(), [6.82413e+00, -6.33260e-01, 2.12580e-01, -2.02768e-02, 2.12873e-04, 3.03781e-01, 7], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=25, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
        

        fitF, params, cParams = rf.cte_(), [0.08], [True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = rf.cte_(), [0.20], [True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = rf.cte_(), [0.25], [True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
    ...
    if False:
        ...
        fitCfg['sigma_cfg'] = [3, 2, 3, 3]
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v0) as f: jsIn = json.load(f)
        recoilLibs_zlib.doFitMultiGauss(bhist, comp, fitCfg, label, outDir_fits_v1, recoil_qTbins, funcJs=jsIn, qTmax=100, qTstartBin=1, xMin=-100, xMax=100, yRatio=1.15)
        return
    ...
    if False:
        ...
        fitF, params, cParams = rf.power_(), [7.39350e-02, 9.99747e-01, 1.27332e+01], [False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = rf.pw_poly4_power_(), [4.29656e+00, -4.45944e-01, 1.97011e-01, -2.37955e-02, 2.23406e-04, 3.93709e-01, 4.74875e+00], [False, False, False, False, False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = rf.pw_poly4_power_(), [6.48045e+00, -9.05744e-02, -9.83584e-03, 4.07583e-03, 5.65448e-04, -1.32482e-01, 4.25126e+00], [False, False, False, False, False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")

        fitF, params, cParams = rf.pw_poly4_power_(), [6.82413e+00, -6.33260e-01, 2.12580e-01, -2.02768e-02, 2.12873e-04, 3.03781e-01, 7], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
    ...
    if False:
        fitCfg['mean_cfg'] = [1, 1, 1, 1] # 0 = floating, 1 = fixed, 2 = parametric (fixed), 3 = parametric (floating)
        fitCfg['sigma_cfg'] = [3, 2, 2, 3]
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v1) as f: jsIn = json.load(f)
        recoilLibs_zlib.doFitMultiGauss(bhist, comp, fitCfg, label, outDir_fits_v2, recoil_qTbins, funcJs=jsIn, qTmax=100, qTstartBin=1, xMin=-100, xMax=100, yRatio=1.15)
        return
    ...
    if False:
        ...
        fitF, params, cParams = rf.pw_poly4_power_(), [8.54115e+00, -1.86875e-01, 1.30649e-01, -1.76670e-02, 2.35614e-04, 4.94044e-01, 5.24853e+00], [False, False, False, False, False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
    ...
    if False:
        fitCfg['mean_cfg'] = [1, 1, 1, 1] # 0 = floating, 1 = fixed, 2 = parametric (fixed), 3 = parametric (floating)
        fitCfg['sigma_cfg'] = [3, 2, 2, 2]
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v2) as f: jsIn = json.load(f)
        recoilLibs_zlib.doFitMultiGauss(bhist, comp, fitCfg, label, outDir_fits_v3, recoil_qTbins, funcJs=jsIn, qTmax=100, qTstartBin=1, xMin=-100, xMax=100, yRatio=1.15)
        return
    ...
    if False:
        ...
        fitF, params, cParams = "power", [1.13476e-01, 8.87581e-01, 1.26066e+01], [False, False, False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")
     
        fitF, params, cParams = "pw_poly4_power", [4.29656e+00, -4.45944e-01, 1.97011e-01, -2.37955e-02, 2.23406e-04, 3.93709e-01, 4.74875e+00], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = "pw_poly4_power", [6.48045e+00, -9.05744e-02, -9.83584e-03, 4.07583e-03, 5.65448e-04, -1.32482e-01, 4.25126e+00], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")

        fitF, params, cParams = "pw_poly4_power", [8.54115e+00, -1.86875e-01, 1.30649e-01, -1.76670e-02, 2.35614e-04, 4.94044e-01, 5.24853e+00], [False, False, False, False, False, False, True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
        

        fitF, params, cParams = "cte", [0.08], [False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = "cte", [0.20], [False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = "cte", [0.25], [False]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "norm3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        

        fitF, params, cParams = "cte", [0.0], [True]
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "mean1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{1} (GeV)", doFit=False)
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "mean2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{2} (GeV)", doFit=False)
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "mean3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{3} (GeV)", doFit=False)
        recoilLibs_zlib.doFit(jsIn, jsOut, comp, "mean4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{4} (GeV)", doFit=False)
    ...
    if True:
        ...
        jsOut = recoilLibs_zlib.combinedFit(bhist, comp, fitCfg, jsIn, recoil_qTbins, qTmax=100) 
...
def do_dymumu_perp_RawPFMET_roofit():
    ...
    fitCfg['sigma'], fitCfg['sigma_cfg'] = [3, 6, 9, 12, 25], [0, 0, 0, 0, 0]
    fitCfg['norm'], fitCfg['norm_cfg'] = [0.15, 0.2, 0.45, 0.197], [1, 1, 1, 1]
    

    recoil_qTbins = list(functions.drange(0, 50, 0.5)) +  list(range(50, 100, 1)) + list(range(100, 150, 2)) + [150]
    recoil_qTbins = list(functions.drange(0, 100, 0.5)) + [100]
    recoil_qTbins = list(range(0, 100)) + [100]
    ...
    fitCfg = {} 
    fitCfg['func_name'] = "func_4gauss"
    fitCfg['func_parms'] = [15, 5, 8, 10]
    
    

    binning_qT = list(functions.drange(0, 100, 0.5)) + [100]
    #binning_qT = list(functions.drange(0, 10, 0.5)) + [10]
    
    bhist = readProc(groups, "recoil_corr_xy_perp_qTbinned", [proc])

    if False:
        #recoilLibs.doFitMultiGauss_zfit(rFile, proc, comp, fitCfg, label, outDir_fits_v0, recoil_qTbins, qTstartBin=1, qTmin=0, qTmax=100, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        rls.doFitMultiGauss_scipy_bhist(bhist, comp, fitCfg, label, outDir_fits_v0, binning_qT, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        #recoilLibs.doFitMultiGauss_scipy(bhist, comp, fitCfg, label, outDir_fits_v0, recoil_qTbins, qTmax=100, qTstartBin=1, xMin=-100, xMax=100, yRatio=1.15, yMin=1e-3, yMax=1e6)
        return
    ...
    if True:
        ...
        fitF, params, cParams = "power", [1, 1, 8], [False, False, False]
        
        #fitF, params, cParams = "pw_poly4_power", [5, 1.26655e+01, 1.38158e-01, 2.35127e-02, -9.87290e-03, 5.84490e-04, 7.47335e-01], [False, False, False, False, False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p0", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = "power", [1, 1, 8], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = "power", [1, 1, 8], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
        
        fitF, params, cParams = "power", [1, 1, 8], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
        return
        #fitF, params, cParams = "pw_poly4_power", [5, 8.41151e+00, 6.44079e-02, 3.61382e-03, -5.45057e-04, 1.49395e-05, 5.43338e-01], [True, False, False, False, False, False, False]
        #recoilLibs.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=20, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
        

        fitF, params, cParams = "cte", [0.08], [False]
        recoilLibs.doFit(jsIn, jsOut, comp, "norm1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = "cte", [0.20], [False]
        recoilLibs.doFit(jsIn, jsOut, comp, "norm2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        #fitF, params, cParams = "cte", [0.25], [False]
        #recoilLibs.doFit(jsIn, jsOut, comp, "norm3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)", doFit=False)
        
        fitF, params, cParams = "cte", [0.0], [True]
        recoilLibs.doFit(jsIn, jsOut, comp, "mean1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=40, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{1} (GeV)", doFit=False)
        recoilLibs.doFit(jsIn, jsOut, comp, "mean2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=40, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{2} (GeV)", doFit=False)
        recoilLibs.doFit(jsIn, jsOut, comp, "mean3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=40, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{3} (GeV)", doFit=False)
        #recoilLibs.doFit(jsIn, jsOut, comp, "mean4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=40, yMin=0, yMax=1, xMax=100, yTitle = "#mu_{4} (GeV)", doFit=False)
    ...
    if False:
        ...
        with open("%s/results.json" % outDir_param_v0) as f: jsIn = json.load(f)
        recoilLibs.doFitMultiGauss_zfit(rFile, proc, comp, fitCfg, label, outDir_fits_v1, recoil_qTbins, funcJs=jsIn, qTstartBin=1, qTmin=0, qTmax=100, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        return
    ...
    if False:       
        ...
        fitF, params, cParams = "pw_poly4_power", [5, 1.26655e+01, 1.38158e-01, 2.35127e-02, -9.87290e-03, 5.84490e-04, 7.47335e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = "pw_poly4_power", [5, 4.21487e+00, -3.21565e-01, 1.40702e-01, -1.63414e-02, 1.68877e-04, 2.08226e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = "pw_poly4_power", [10, 6.47251e+00, -1.59090e-01, 4.80671e-02, -2.90753e-03, 1.81379e-05, 7.83569e-03], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")

        fitF, params, cParams = "pw_poly4_power", [5, 8.41151e+00, 6.44079e-02, 3.61382e-03, -5.45057e-04, 1.49395e-05, 5.43338e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
    ...
    if False:
        ...
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v1) as f: jsIn = json.load(f)
        recoilLibs.doFitMultiGauss_zfit(rFile, proc, comp, fitCfg, label, outDir_fits_v2, recoil_qTbins, funcJs=jsIn, qTmax=100, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        return
    ...
    if False:
        ...
        fitF, params, cParams = "pw_poly4_power", [5, 8.58617e+00, -2.33559e-01, 1.39475e-01, -1.81754e-02, 2.39596e-04, 4.95055e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma4", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
    ...
    if False:
        ...
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v2) as f: jsIn = json.load(f)
        recoilLibs.doFitMultiGauss_zfit(rFile, proc, comp, fitCfg, label, outDir_fits_v3, recoil_qTbins, funcJs=jsIn, qTmax=100, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        return
    ...
    if False:
        ...
        fitF, params, cParams = "pw_poly4_power", [10, 1.27186e+01, 1.13231e-01, -8.62916e-03, 1.97555e-04, 2.42194e-05, 7.35975e-01], [True, False, False, False, False, False, False]
        #fitF, params, cParams = "linear", [10, 1.26655e+01], [False, False]
        excludeBins=[44,53]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=100, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)", excludeBins=excludeBins)
    ...
    if True:
        ...
        fitCfg['norm_cfg'] = [1, 1, 1]
        with open("%s/results.json" % outDir_param_v3) as f: jsIn = json.load(f)
        #jsOut = recoilLibs.combinedFit(rFile, proc, comp, fitCfg, jsIn, recoil_qTbins, qTmax=100)
        #jsOut = recoilLibs.combinedFit_zlib_cond(rFile, proc, comp, fitCfg, jsIn, recoil_qTbins, qTmax=100)
        #jsOut = recoilLibs.combinedFit_scipy(rFile, proc, comp, fitCfg, jsIn, recoil_qTbins, qTmax=qTmax)
        #with open("%s/results_refit.json" % outDir_refit, "w") as outfile: json.dump(jsOut, outfile, indent=4)
        ...
        '''
        print(jsIn)
        recoilLibs.doPlot(comp, "norm1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=qTmax, yTitle = "n_{1} (GeV)")
        recoilLibs.doPlot(comp, "norm2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=qTmax, yTitle = "n_{2} (GeV)")
        recoilLibs.doPlot(comp, "norm3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=qTmax, yTitle = "n_{3} (GeV)")
        recoilLibs.doPlot(comp, "sigma1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=qTmax, yTitle = "#sigma_{1} (GeV)")
        recoilLibs.doPlot(comp, "sigma2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=qTmax, yTitle = "#sigma_{2} (GeV)")
        recoilLibs.doPlot(comp, "sigma3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=qTmax, yTitle = "#sigma_{3} (GeV)")
        recoilLibs.doPlot(comp, "sigma4", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=qTmax, yTitle = "#sigma_{4} (GeV)")
        recoilLibs.doPlot(comp, "mean1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "#mu_{1} (GeV)")
        recoilLibs.doPlot(comp, "mean2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "#mu_{2} (GeV)")
        recoilLibs.doPlot(comp, "mean3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "#mu_{3} (GeV)")
        recoilLibs.doPlot(comp, "mean4", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "#mu_{4} (GeV)")
        '''
        outDir_refit_fits = "%s/fits_refit" % baseDir
        recoilLibs.doFitMultiGauss_scipy(rFile, proc, comp, fitCfg, label, outDir_refit_fits, recoil_qTbins, doFit=False, funcJs=jsIn, xMin=-100, xMax=100, qTmax=qTmax, yMin=1e-3, yMax=1e6)
        ROOT.gROOT.Reset()
...
def do_dymumu_perp_RawPFMET():
    ...
    fitCfg = {} 
    fitCfg['func_name'] = "func_4gauss_perp"
    fitCfg['func_parms'] = [15, 5, 8, 10]
    ...
    if False:
        ...
        rls.doFit(jsIn, jsOut, comp, "p0", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = "power", [4.66409e-01, 3.46158e-01, 3.44635e+00], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p1", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = "power", [5.18556e-01, 3.95983e-01, 5.62069e+00], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p2", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
        
        fitF, params, cParams = "power", [3.01503e-01, 5.26286e-01, 8.13076e+00], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p3", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
    ...
    if True:
        ...
        with open("%s/results.json" % outDir_param_v0) as f: jsIn = json.load(f)
        fitCfg = {} 
        fitCfg['func_name'] = "mc_perp"
        fitCfg['func_parms'] = []
        for k in range(0, 4):
            for l in range(0, 3):
                fitCfg['func_parms'].append(jsIn["p%d"%k]["p%d"%l])

        jsOut = rls.combinedFit_scipy(bhist, comp, fitCfg, jsIn, binning_qT)
...
def do_dymumu_perp_RawPFMET_narf():

    proc = "Zmumu"
    tag = "zmumu_perp"
    comp = "perp"
    baseDir = "%s/%s_narf" % (outDir, tag)
    name = "DY #rightarrow #mu^{+}#mu^{#minus}"
    label = "%s, %s" % (name, met)
    functions.prepareDir(baseDir, False)
    ...
    if False:
        recoilLibs.doFitMultiGauss_narf(rFile, proc, comp, fitCfg, label, outDir_fits_v0, recoil_qTbins, qTstartBin=1, qTmin=0, qTmax=100, xMin=-100, xMax=100, yMin=1e-3, yMax=1e6)
        return
    ...
    if False:
        ...
        fitF, params, cParams = "pw_poly4_power", [5, 1.26655e+01, 1.38158e-01, 2.35127e-02, -9.87290e-03, 5.84490e-04, 7.47335e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma1", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=20, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")

        fitF, params, cParams = "pw_poly4_power", [5, 4.21487e+00, -3.21565e-01, 1.40702e-01, -1.63414e-02, 1.68877e-04, 2.08226e-01], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma2", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=60, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        
        fitF, params, cParams = "pw_poly4_power", [3, 6.87741e+00, -7.30878e-01, 2.84413e-01, -3.09880e-02, 2.66019e-04, 6.37031e-02], [True, False, False, False, False, False, False]
        recoilLibs.doFit(jsIn, jsOut, comp, "sigma3", fitF, params, outDir_param, recoil_qTbins, label, cParams=cParams, fitMin=0, fitMax=20, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
    ...
    if True:
        ...
        with open("%s/results_refit.json" % outDir_refit) as f: jsIn = json.load(f)
        recoilLibs.doPlot(comp, "norm1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=100, yTitle = "n_{1} (GeV)")
        recoilLibs.doPlot(comp, "norm2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=100, yTitle = "n_{2} (GeV)")
        recoilLibs.doPlot(comp, "norm3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=100, yTitle = "n_{3} (GeV)")
        recoilLibs.doPlot(comp, "sigma1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{1} (GeV)")
        recoilLibs.doPlot(comp, "sigma2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{2} (GeV)")
        recoilLibs.doPlot(comp, "sigma3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{3} (GeV)")
        recoilLibs.doPlot(comp, "sigma4", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=50, xMax=100, yTitle = "#sigma_{4} (GeV)")
        recoilLibs.doPlot(comp, "mean1", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "n_{1} (GeV)")
        recoilLibs.doPlot(comp, "mean2", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "n_{2} (GeV)")
        recoilLibs.doPlot(comp, "mean3", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "n_{3} (GeV)")
        recoilLibs.doPlot(comp, "mean4", jsIn, outDir_refit, recoil_qTbins, label, yMin=0, yMax=1, xMax=1, yTitle = "n_{4} (GeV)")

        outDir_refit_fits = "%s/fits_refit" % baseDir
        recoilLibs.doFitMultiGauss(rFile, proc, comp, fitCfg, label, outDir_refit_fits, recoil_qTbins, funcJs=jsIn, xMin=-100, xMax=100, qTmax=100, yMin=1e-3, yMax=1e6)
        ROOT.gROOT.Reset()
...
def do_dymumu_para_RawPFMET():
    ...
    fitCfg = {} 
    fitCfg['func_name'] = "func_4gauss_para"
    fitCfg['func_parms'] = [15, 5, 8, 10, 0, 0]

    binning_qT = list(functions.drange(0, 100, 0.5)) + [100]
    #binning_qT = list(functions.drange(0, 10, 0.5)) + [10]
    
    bhist = readProc(groups, "recoil_corr_xy_para_qT_qTbinned", [proc])
    ...
    if True:
        ...
        fitF, params, cParams = "power", [3.01503e-01, 5.26286e-01, 8.13076e+00], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p4", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yMin=-5, yTitle = "#sigma_{3} (GeV)")

        fitF, params, cParams = "power", [3.01503e-01, 5.26286e-01, 8.13076e+00], [False, False, False]
        rls.doFit(jsIn, jsOut, comp, "p5", fitF, params, outDir_param, binning_qT, label, cParams=cParams, fitMin=0, fitMax=100, yMax=50, xMax=100, yMin=-5, yTitle = "#sigma_{3} (GeV)")
...
def do_dymumu_para_RawPFMET_old():
...
def prepareFile(fInName, fOutName):
    ...
    datagroups = datagroupsLowPU(fInName, flavor=flavor)
...
if __name__ == "__main__":
    ...
    #rFile = "tmp/lowPU_%s_%s.root" % (flavor, met)
    #prepareFile("lowPU_%s_RawPFMET_%s_nnpdf31.pkl.lz4" % (flavor, met), rFile)
    #sys.exit()
