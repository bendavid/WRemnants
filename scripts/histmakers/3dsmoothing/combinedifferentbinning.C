//TO BE USED IN CASE WE NEED TO COMBINE EFFICIENCIES SMOOTHED IN DIFFERENT PT RANGES (AT THE MOMENT THE SMOOTHER DOESN'T DO IT, SO A WORKAROUND IS TO CHANGE THE PT RANGE IN THE HISTOGRAMS AND THEN ADD THE REMAINING BINS FROM ANOTHER FILE). THIS ALSO IMPLEMENTS THE CORRECTION TO ALTERNATE FITS (ASSUMING THE HISTOGRAMS WITH FULL BINNING IS THE ONE WITH 2D EFFICIENCIES, FOR WHICH YOU ALSO HAVE ALT SIG FIT CONVERGENCE -> SENSIBLE ALT FITS)
