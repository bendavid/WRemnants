...
void makenew2dsf() {
	...
	TFile *file2=new TFile("/gpfs/ddn/cms/user/bruschin/Newtest/smoothLeptonScaleFactorsredohighpt/GtoH/allSmooth_GtoH.root");
	TFile *file3=new TFile("/gpfs/ddn/cms/user/bruschin/Newtest/WRemnants/wremnants/data/testMuonSF/allSmooth_GtoH3Dsfisoabcd.root","RECREATE");
	file3->cd();
	TH2D *Histo1, *Histo2;
