...
parser.add_argument("--era", type=str, help="era when the dataset was taken", default="2016PostVFP")
parser.add_argument("--noMuonCorr", type=int, default=1)
parser.add_argument("--noScaleFactors", type=int, default=1)
