...
python3 scripts/combine/pullsAndImpacts.py -g -f $1 output -o ${2/.html/_grouped.html} --otherExtensions pdf png html 
python3 scripts/combine/pullsAndImpacts.py -f $1 output -o $2 --otherExtensions pdf png -n 50
