...
def fit_hist(hist, func, initial_parmvals, max_iter = 5, edmtol = 1e-5, mode = "chisq", norm_axes = None, xargs=(), bnds=None, sumw2=False):
    ...
    for iiter in range(max_iter):
        res = scipy.optimize.minimize(scipy_loss, current_parmvals, method = "trust-krylov", jac = True, hessp = scipy_hessp, args=xargs, bounds=bnds) #  trust-krylov COBYLA  L-BFGS-B trust-ncg
