...
def fit_hist(hist, func, initial_parmvals, max_iter = 5, edmtol = 1e-5, mode = "chisq", norm_axes = None, args = ()):
    ...
    for iiter in range(max_iter):
        ...
        res = scipy.optimize.minimize(scipy_loss, current_parmvals, method = "trust-krylov", jac = True, hessp = scipy_hessp, args=args) # trust-constr trust-krylov
        ...
        print(f"Iteration {iiter}, loss={loss}, edmval={edmval}, eigvals[0]={eigvals[0]}")
