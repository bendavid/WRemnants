// Single-core libtorch C++ benchmark for the flow polyhead AOTI .pt2
// produced by ``flow_polyhead_export.py``.
//
// Each .pt2 is compiled for a specific static batch size; this binary
...
//
// The downstream weight evaluation forms perturbations and computes
// W_pred = positivity(joint(u, σ)) outside the model. This bench
// times the polyhead-only forward — the per-event NN cost.
//
...
//         bench_aoti_polyhead.cpp \
//         -ltorch -ltorch_cpu -lc10 -lpthread \
//         -o bench_aoti_polyhead
