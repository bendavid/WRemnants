...
axis_charge = hist.axis.Regular(2, -2., 2., underflow=False, overflow=False, name = "charge", metadata="reco")

down_up_axis = hist.axis.Regular(2, -2., 2., underflow=False, overflow=False, name = "downUpVar", metadata="syst")
down_nom_up_axis = hist.axis.Regular(3, -1.5, 1.5, underflow=False, overflow=False, name = "downNomUpVar", metadata="syst")
...
axis_passIso = hist.axis.Boolean(name = passIsoName, metadata="reco")
axis_passMT = hist.axis.Boolean(name = passMTName, metadata="reco")
