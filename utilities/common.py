...
def common_parser(for_reco_highPU=False):
    ...
    if for_reco_highPU:
        ...
        parser.add_argument("--biasCalibration", type=str, default=None, choices=["binned","parameterized"], help="Adjust central value by calibration bias hist for simulation")
