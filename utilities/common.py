...
def common_parser(for_reco_highPU=False):
    ...
    parser.add_argument("--nonClosureScheme", type=str, default = "A-M-separated", choices=["none", "A-M-separated", "A-M-combined", "binned", "binned-plus-M", "A-only", "M-only"], help = "source of the Z non-closure nuisances")
    ...
    parser.add_argument("--dummyNonClosureA", action="store_true", help="use a dummy value for the magnetic part of the Z non-closure")
