...
def common_parser(for_reco_highPU=False):
    ...
    parser.add_argument("--theoryCorr", nargs="*", choices=theory_corrections.valid_theory_corrections(),
...
def common_parser_combine():
    ...
    parser.add_argument("--resumUnc", default=None, type=str, choices=["scale", "tnp"], help="Include SCETlib uncertainties")
