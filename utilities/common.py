...
def common_parser(for_reco_highPU=False):
    ...
    parser.add_argument("--addTheoryCorrs", nargs="*", default=["winhacnloew", "virtual_ew_wlike", "pythiaew_ISR", "horaceqedew_FSR", "horacelophotosmecoffew_FSR", "scetlib_dyturboMSHT20mbrange", "scetlib_dyturboMSHT20mcrange"],
